        ...
        <table className="mt-3 ml-8 text-sm">
          <thead>
            <tr className="border-b border-muted">
              <th className="pr-6 pb-1 text-left text-xs uppercase tracking-wider text-muted-foreground font-semibold">HCPC</th>
              <th className="pb-1 text-left text-xs uppercase tracking-wider text-muted-foreground font-semibold">Modifiers</th>
            </tr>
          </thead>
          <tbody>
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-subtle">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className={`${isEscalated ? "bg-red-700" : "bg-gradient-navy"} text-navy-foreground border-b-4 border-b-violet-400`}>
