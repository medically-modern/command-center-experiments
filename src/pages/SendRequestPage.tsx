/**
 * Send Request — standalone view of masheke-checklist's "Send Request" tab.
 */
...
const SendRequestPage = () => {
  ...
  const { patients, loading, error, refetch, update, clearOverlay , saveOverlay, hasOverlay } = useMondayPatients("sendRequest", searchParams.get("patientId"));
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gradient-subtle">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className={`${isEscalated ? "bg-red-700" : "bg-gradient-navy"} text-navy-foreground border-b-4 border-b-teal-400`}>
